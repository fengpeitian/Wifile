...
public final class ViewfinderView extends View {
    ...
    private void initView() {
        reactColor = ContextCompat.getColor(getContext(), ZxingSetting.reactColor);
        frameLineColor = ContextCompat.getColor(getContext(), ZxingSetting.frameLineColor);
        scanLineColor = ContextCompat.getColor(getContext(), ZxingSetting.scanLineColor);
